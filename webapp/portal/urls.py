...
urlpatterns = [
    ...
    path("api/candidates/<uuid:candidate_id>/status", views.candidate_status_api, name="candidate_status_api"),
    path("api/candidates/<uuid:candidate_id>/delete", views.candidate_delete_api, name="candidate_delete_api"),
